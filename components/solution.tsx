...
export function Solution() {
  ...
  return (
    <section 
      className="relative max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-24 overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0" style={{
        background: `radial-gradient(400px circle at ${mouseX}px ${mouseY}px, rgba(255,77,0,0.1), transparent 40%)`
      }} />
